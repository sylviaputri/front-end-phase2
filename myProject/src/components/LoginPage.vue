    ...
    <div class="section" id="section-1">
      <div class="whiteColor vertical-center" style="background-color: rgba(46, 84, 101, 86%); height:100%">
        ...
        <div class="float-left border border-3 rounded text-center mx-auto" style="width: 30%; height:65%;">
          ...
          <!-- <button type="button" id="btnSignIn" class="btn btn-primary border border-2 rounded" @click="setLayout('app-layout')">SIGN IN</button> -->
          <router-link to="/trainee/home" @click.native="setLayout('app-layout')">
